    ...
    if (interaction.isModalSubmit()) {
        ...
        if (interaction.customId === 'schedule-msg') {
            ...
            SCHEDULE.findOne({
                ...
                if (imageInput && !imageInput.includes('cdn.discord')) return interaction.reply({ content: `Unable to schedule a message considering your formatting was incorrect. Please double check the **image URL formatting** you used, and try again. Please make sure it is a CDN Discord attachment.`, ephemeral: false });
