...
module.exports = {
    ...
    async execute(interaction) {
        ...
        channelDisconnect.members.each(async (member) => {

            await member.voice.disconnect().then(async() => await interaction.reply(`Disconnected all members from ${channelDisconnect}. <:bITFVictory:1063265610303295619>`));
