...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addBooleanOption((option) =>
            option.setName('hidden')
                .setDescription('This parameter requires you to input whether the message is put in chat or sent privately to you')
                .setRequired(true)
        ),
    ...
    async execute(interaction) {
        ...
        if (isHidden) {
            ...
            await interaction.reply({ content: hotlineInformation, ephemeral: true });

        } else if (!isHidden) {

            await interaction.reply({ content: hotlineInformation, ephemeral: false });
