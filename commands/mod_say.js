...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (attachment) {
            ...
            }).then((sent) => interaction.reply(`Sent bot message in ${channel} with **${sent.attachments.size} attachment(s)**. <:bITFVictory:1063265610303295619>`));
            ...
            }).then(() => interaction.reply(`Sent bot message in ${channel} with **no attachments**. <:bITFVictory:1063265610303295619>`));
